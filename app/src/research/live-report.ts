...
<section class="hero"><span>TRACEABLE SELLER REPORT</span><h1>${escapeHtml(evidencePackage.researchInput.productName)}</h1><p>先看六大卖家问题的核心结论；展开每张卡片即可核对证据等级、来源和仍需补证的事项。</p></section>
...
<section class="report"><header><span class="eyebrow" style="color:var(--orange)">SELLER QUESTIONS</span><h2>六大卖家问题</h2><p>结论默认可见，研究过程和审计细节按需展开。</p></header><div class="grid">
