...
import { SourceSystemAnimation } from "./source-system-animation";
      ...
      <main className="home-product-page">
        ...
        <section className="home-story-product-view">
          <header>
            ...
            <h2 className="home-whiteboard-headline">
              <span>从开始调研，到形成决策，</span>
              <span>完整过程都在一张白板上实时展开。</span>
            </h2>
